...
CRUD::resource('studentsubscriptionpayment2', 'Admin\StudentSubscriptionPaymentCrudControllerReadonly');
...
CRUD::resource('xuserprofile', 'Admin\XUserProfileCrudController');
