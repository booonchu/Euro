...
class ReportCrudController extends CrudController {
	...
	public function setUp() {
		...
		*/
        ...
        $this->crud->setEntityNameStrings('รายงาน', 'รายงาน');
		...
		*/
		...
		$this->crud->addButton('top', 'report', 'view', 'vendor/backpack/crud/buttons/report', 'beginning');
		$this->crud->removeButton('create');
		$this->crud->removeButton('update');
		$this->crud->removeButton('delete');
		
        // ------ CRUD ACCESS
       // $this->crud->allowAccess(['create', 'update', 'reorder', 'delete']);
